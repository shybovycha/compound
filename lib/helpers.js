...
HelperSet.prototype.fieldsFor = function(resource, formParams, block) {
    ...
    var blockHelper = {
        ...
        textarea: function(name, params) {
            ...
            return genericTag('textarea', sanitizeHTML(value), {
                name: makeName(name),
                id: makeId(name)
            }, params);
        },
        ...
        select: function(name, options, params) {
            ...
            // Render the select
            return HelperSet.prototype.selectTag(innerOptions, {
                name: makeName(name),
                id: makeId(name)
            }, params);
        }
...
/**
 * Input tag helper. You can set the error message for this input using
 * this syntax:
 *
 *   resource.errors_for = { input_name: "error message" };
 *
 * @methodOf HelperSet.prototype
...
HelperSet.prototype.inputTag = function(params, override) {
    if (this.formResource && this.formResource.errors_for && params && params['name'] && this.formResource.errors_for[params['name']]) {
        var error_msg = this.formResource.errors_for[params['name']].toString(),
            error = '<div class="error-message" for="' + params['name'] + '">' + error_msg + '</div>',
            input = '<input' + htmlTagParams(params, override) + ' />';
