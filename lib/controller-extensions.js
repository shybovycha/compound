...
Controller.prototype.render = function(arg1, arg2) {
    ...
    sys.puts('Rendering: ' + $(compound.structure.views[file]).bold.green + ' with layout ' + $(layout).bold.green);

    var filename = path.normalize(compound.structure.views[file]);
